    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-4">
          ...
          {project.badge && (
            <div className="inline-flex flex-wrap items-center gap-2 px-3 py-1 rounded-full bg-indigo-100/80 dark:bg-white/10 text-indigo-800 dark:text-indigo-200 text-[11px] font-semibold uppercase tracking-[0.18em]">
              {project.badge}
            </div>
          )}
            ...
            {project.extraLink && (
              ...
              >
                <motion.button
                  whileHover={{ scale: 1.03 }}
                  whileTap={{ scale: 0.97 }}
                  className="w-full px-4 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-500 text-white rounded-lg hover:shadow-glow-lg transition-all duration-300 flex items-center justify-center gap-2 group/btn font-medium"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5h7m0 0v7m0-7L10 19l-5-5" />
                  </svg>
                  <span>{project.extraLink.label}</span>
                </motion.button>
              </a>
            )}
            {project.demo && (
